...
<!-- ===============================================MAIN NAVBAR========================================== -->
      ...
      <div class="user-panel">
        ...
        $db = mysqli_connect("localhost","u733437513_03132804Jaypog","C5;ev2HZ[8v","u733437513_enrollment"); //keep your db name
      ...
      elseif($_SESSION['role'] == "Student"){
                            echo '
        <li>
          <a href="../enrolled_subj/enrolled_subj.php?stud_id='.$_SESSION['userid'].'"><i class="fa fa-eye"></i> <span>View Enrolled Subjects</span></a>
        </li>
         <!-- remove muna for the meantime hehehe
        <li>
          <a href="../grade/my_grade.php?stud_id='.$_SESSION['userid'].'"><i class="fa fa-eye"></i> <span>View Grade</span></a>
        </li>
        -->
        <li>
          <a href="../grade/history.php?stud_id='.$_SESSION['userid'].'"><i class="fa fa-eye"></i> <span>Grade History</span></a>
        </li>
